...
> 2021-09-26 부터 [https://til.wookiist.dev](https://til.wookiist.dev)에 정리하고 있습니다. 이전 작업도 함께 이루어지고 있으니 많관부입니다!! :D
...
<<<<<<< HEAD
=======
- [x] [2021-09-25](./2021-09/210925.md) - 실리콘밸리의 문화에 대해 생각해보는 시간을 가졌다. 익숙한 Rank-driven 구조에서 벗어나 Role-driven 구조로 가게 된다면 나는 어떤 것들을 준비해야 할지도 깊이 고민해보는 시간을 보냈다. 해당 내용은 정리해서 오랜만에 포스팅했다. TIL에는 포스팅한 내용을 카피해서 넣었다.
>>>>>>> 72cfcaf00b4199ab392cf0297df124591248e36a
- [x] [2021-09-24](./2021-09/210924.md) - 데이터 파이프라인에서 전통적인 방식의 데이터 웨어하우스와 필요한 데이터만을 추출해서 갖고 있는 데이터 마트에 대한 스터디를 진행했다. 중요한 것은 데이터 파이프라인을 통해 데이터를 수집하는 목적인데, 이 목적에는 데이터에 대해 검색을 하기 위함일 수도 있고, 데이터를 잘 가공하기 위함일 수도 있다. 또는 데이터를 잘 시각화해서 알고 싶은 정보를 얻을 수도 있다. 그나저나 TIL 진행 방식을 위키 페이지 형태로 변환하는 작업을 어서 해야겠다... 
- [x] [2021-09-23](./2021-09/210923.md) - 데이터 파이프라인이 공통적으로 갖는 컴포넌트들에 대한 이해가 필요하다. 현재 '빅데이터를 지탱하는 기술'이라는 책을 읽으면서 스터디 중인데, 노션에 정리한 내용을 TIL로 옮겨서 공부한 내용을 적는게 좋을지, 아니면 분리해서 내용을 올리는게 좋을지 고민이다.
